# config.py
# (Modificado para mover o troféu)
...
SERVER_IP = "127.0.0.1"
PORT = 5555
conveyor_speed = 2  # <--- Variável que faltava
...
WEAPON_SHOP_ITEMS_DATA = {
    ...
    "Raio Orbital": {"cost": 500, "desc": "Atordoa(3s)+Devolve", "rect": (
        WEAPON_START_X + (WEAPON_WIDTH + WEAPON_PADDING) * 2, WEAPON_Y, WEAPON_WIDTH, WEAPON_HEIGHT),
                     "type": "consumable"}

    # --- TROFÉU REMOVIDO DAQUI ---
}

# --- LOJA DO TROFÉU (NOVO) ---
# (Posicionado entre as bases 1 e 2)
TROPHY_SHOP_COST = 25000
TROPHY_SHOP_RECT_DATA = ((SCREEN_WIDTH // 2) - 75, 65, 150, 70)  # (x, y, w, h)